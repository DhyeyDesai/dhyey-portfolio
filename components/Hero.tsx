    ...
    <div className="relative flex flex-col items-center justify-center h-screen w-full overflow-hidden bg-background perspective-1000">
      ...
      <div className="z-10 flex flex-col items-center justify-center text-center px-4 max-w-5xl transform-style-3d">
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl lg:text-8xl font-serif tracking-tight text-white mb-12 drop-shadow-lg"
        >
          Hi, I am <span className="font-black italic text-gray-200 ">Dhyey</span>.
        </motion.h1>
        ...
        >
          <div className="p-8 group transition-colors">
            <p className="text-xl md:text-2xl text-gray-200 max-w-2xl leading-relaxed font-medium">
              I build accessible, pixel-perfect, performant, and flashy web experiences.
            </p>
          </div>
        </motion.div>
